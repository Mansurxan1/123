  ...
  return (
    <div className="bg-white">
      ...
      <div className="flex items-center text-center gap-3 mb-4 rounded-bl-[20px] rounded-br-[20px] border-b-[2px] border-b-[#00000050] px-3 pb-4">
        ...
        <h2 className="text-2xl w-full font-semibold">{product.name_uz}</h2>
      </div>
      ...
      <div className="p-4 rounded-[30px] z-2  bg-white relative -top-7">

        <h3 className="text-xl text-center font-bold mt-3">Mahsulot Hajmi:</h3>
        ...
        {selectedSize && !showQuantity && (
          ...
          >
            <ShoppingCart className="h-5 w-5" /> Savatga qo‘shish
          </button>
        )}
        ...
        {showQuantity && (
          <div className="flex items-center justify-between mt-4">
            ...
            <p className="text-lg font-semibold">
              Narxi: {totalPrice.toLocaleString()} uzs
            </p>
          </div>
        )}
